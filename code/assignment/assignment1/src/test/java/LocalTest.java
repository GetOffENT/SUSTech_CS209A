...
//    OlympicsAnalyzer olympicsAnalyzer = new OlympicsAnalyzer(Paths.get("src", "local_test_data").toString());
    OlympicsAnalyzer olympicsAnalyzer = new OlympicsAnalyzer(Paths.get("src/main/resources", "local_test_data").toString());
...
//    }
    ...
    @Test
    public void test(){
        String path = Paths.get("src", "local_test_data").toString();
        path = "src/main/resources/local_test_data/Olympic_Results.csv";
    ...
    public void testCSVReader(){
        String path = "src/main/resources/local_test_data/Olympic_Athlete_Bio_filtered.csv";
        List<AthleteBioFiltered> data1 = CSVReader.mapCsvToClass(path, AthleteBioFiltered.class);
        System.out.println("Olympic_Athlete_Bio_filtered.size() = " + data1.size());

        path = "src/main/resources/local_test_data/Olympic_Athlete_Event_Results.csv";
        List<AthleteEventResult> data2 = CSVReader.mapCsvToClass(path, AthleteEventResult.class);
        System.out.println("Athlete_Event_Results.size() = " + data2.size());

        path = "src/main/resources/local_test_data/Olympic_Games_Medal_Tally.csv";
        List<GamesMedalTally> data3 = CSVReader.mapCsvToClass(path, GamesMedalTally.class);
        System.out.println("Olympic_Games_Medal_Tally.size() = " + data3.size());

        path = "src/main/resources/local_test_data/Olympic_Results.csv";
        List<Result> data4 = CSVReader.mapCsvToClass(path, Result.class);
        System.out.println("Olympic_Results.size() = " + data4.size());

        path = "src/main/resources/local_test_data/Olympics_Country.csv";
        List<Country> data5 = CSVReader.mapCsvToClass(path, Country.class);
        System.out.println("Olympics_Country.size() = " + data5.size());

        path = "src/main/resources/local_test_data/Olympics_Games.csv";
        List<Game> data6 = CSVReader.mapCsvToClass(path, Game.class);
        System.out.println("Olympics_Games.size() = " + data6.size());
    }
    ...
    void topPerformantFemale() {
        ...
        System.out.println(expectedAthletes);
